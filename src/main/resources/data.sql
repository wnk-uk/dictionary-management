...
VALUES
	...
	('Wendy', '2024-03-07 06:05:30', 'C', 'ACCEPTANCE'),
	('Xander', '2024-03-07 07:15:45', 'C', 'PROGRESS'),
	('Yara', '2024-03-07 08:25:55', 'C', 'REQUEST'),
	('Zack', '2024-03-07 09:35:40', 'C', 'HOLDING'),
	('Aaron', '2024-03-08 10:45:30', 'C', 'ACCEPTANCE'),
...
VALUES
	...
	(15, 'WELCOME', 'en_US', 'WELCOME', 'Welcome', 'WLC', 'button', '/home', '/src/components/button.js', 'Welcome message update', 'COMPLETE'),
    ...
    (16, 'LOGOUT', 'ko_KR', 'LOGOUT', '로그아웃', '로그아웃', 'label', '/logout', '/src/components/label.js', 'Korean logout update', 'COMPLETE'),
    ...
    (18, 'SETTINGS', 'en_US', 'SETTINGS', 'Settings', 'SET', 'button', '/settings', '/src/components/button.js', 'Settings update', 'COMPLETE'),
    ...
    (19, 'PROFILE', 'ko_KR', 'PROFILE', '프로필', '프로필', 'label', '/profile', '/src/components/label.js', 'Korean profile update', 'COMPLETE'),
    ...
    (21, 'DOWNLOAD', 'en_US', 'DOWNLOAD', 'Download', 'DWL', 'button', '/download', '/src/components/button.js', 'Download button update', 'COMPLETE'),
    ...
    (22, 'SEARCH', 'ko_KR', 'SEARCH', '검색', '검색', 'label', '/search', '/src/components/label.js', 'Korean search update', 'COMPLETE'),
    ...
    (24, 'INFO', 'en_US', 'INFO', 'Information', 'INFO', 'button', '/info', '/src/components/button.js', 'Info page update', 'COMPLETE'),
    ...
    (25, 'ERROR', 'ko_KR', 'ERROR', '오류', '오류', 'label', '/error', '/src/components/label.js', 'Korean error update', 'COMPLETE'),
    ...
    (27, 'CONFIRM', 'en_US', 'CONFIRM', 'Confirm', 'CFM', 'button', '/confirm', '/src/components/button.js', 'Confirm button update', 'COMPLETE'),
    ...
    (28, 'CANCEL', 'ko_KR', 'CANCEL', '취소', '취소', 'label', '/cancel', '/src/components/label.js', 'Korean cancel update', 'COMPLETE'),
    ...
    (30, 'RECEIVE', 'en_US', 'RECEIVE', 'Receive', 'RCV', 'button', '/receive', '/src/components/button.js', 'Receive button update', 'COMPLETE'),
